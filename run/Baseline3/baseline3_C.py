...
if __name__ == '__main__':
    ...
    test_path = os.path.join(config['dataset_path'], 'test_features.pt')
    test_loader = do_dataLoader(test_path, 'test', 'player_features', batch_size=config['batch_size'], num_workers=config['num_workers'], shuffle=False, pin_memory=config['pin_memory'])

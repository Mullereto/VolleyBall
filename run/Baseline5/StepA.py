...
from Model_classes.Baseline5 import Baseline5_feature_extractor_per_person
...
config = load_config(r"D:\project\Python\DL(Mostafa saad)\Project\VolleyBall\config\base5_A_config.yml")
...
if __name__ == '__main__':
    ...
    model = Baseline5_feature_extractor_per_person()
